export default () => ({
  ...
  "accounts": "Konten",
  "help": "Hilfe",
  "followingDescription": "Beiträge von gefolgten Nutzern.",
  "globalline": "Globaler Feed",
  "globallineDescription": "Alle Beiträge in Echtzeit.",
  "trending": "Trends",
  "trendingDescription": "Trending-Themen.",

  // ============================================================================
  // AUTHENTICATION & LOGIN
  // ============================================================================
  "login": "Anmelden",
  "loginWithOAuth": "Mit OAuth anmelden",
  "service": "Host-Anbieter",
  "identifier": "E-Mail/Handle/DID",
  "password": "Passwort/App-Passwort",
  "getAppPassword": "App-Passwort holen",
  "authFactorToken": "2FA-Code",
  "authFactorTokenMessage": "2FA-Code gesendet. Code eingeben und erneut anmelden.",
  "myAccounts": "Meine Konten",
  "loginFailed": "Login fehlgeschlagen. Eingaben prüfen.",
  "sessionExpired": "Session abgelaufen. Neu anmelden.",
  ...
  "confirmInviteCodes": "Codes bestätigen",
  "copyInviteCode": "Kopieren",
  "userOfInviteCode": "Verwendet",
  "noInviteCodes": "Keine Einladungscodes. App-Passwörter können keine Codes abrufen.",
  ...
  "reply": "Antwort",
  "replies": "Antworten",
  "replyUnknown": "Antwort unbekannt",
  "like": "Gefällt mir",
  "likes": "Gefällt mir",
  "repost": "Repost",
  "reposts": "Reposts",
  ...
  "createRepostConfirmation": "Beitrag reposten?",
  "deleteRepost": "Repost löschen",
  "deleteRepostConfirmation": "Repost abbrechen?",
  ...
  "sendPostNotification1": "[TEXT](URL) möglich.",
  "sendPostNotification2": "Zap-Links mit @zap (Lightning nötig).",
  "sendPostNotification3": "Linkkarten-URL: Web-URL, Post/Feed/Listen AT URI.",
  "sendPostNotification4": "Animierte Bilder: .gif/.apng/.webp (inoffiziell).",
  "sendPostNotification5": "Zeichenlimit überschreitbar.",
  "sendPostReset": "Alle Eingaben zurücksetzen",
  "sendPostResetMessage": "Eingaben zurücksetzen?",
  "postDate": "Beitragsdatum",
  "postDatePopupTitle": "Beitragsdatum festlegen",
  "postDatePopupDescription": "Beitrag mit diesem Datum senden.\nGültig: Jahr 10 bis heute.",
  "postDatePopupReset": "Datum zurücksetzen",
  "postDatePopupResetDescription": "Datum zurücksetzen?",
  "emptyPostConfirmation": "Leerer Beitrag",
  "emptyPostConfirmationMessage": "Beitrag ist leer. Trotzdem posten?",

  // ============================================================================
  // POST ACTIONS
  // ============================================================================
  "copyHandle": "Handle kopieren",
  "copyOfficialUrl": "URL kopieren",
  "copyAtUri": "URI kopieren",
  "copyDid": "DID kopieren",
  "copyDisplayName": "Anzeigename kopieren",
  "likeUsers": "Gefällt mir von",
  "quoteRepostsList": "Zitate",
  "repostUsers": "Repostet von",
  "pinnedPost": "Angehefteter Beitrag",
  "pinnedPostOn": "Beitrag anheften",
  "pinnedPostOff": "Beitrag lösen",
  ...
  "deletePostMessage": "Beitrag löschen?",
  ...
  // USER MANAGEMENT
  // ============================================================================
  "mutingUsers": "Stumme Nutzer",
  "checkMutingUsers": "Stumme Nutzer zeigen",
  "blockingUsers": "Blockierte Nutzer",
  "checkBlockingUsers": "Blockierte Nutzer zeigen",
  "noFollowings": "Nutzer folgt niemandem.",
  "noFollowers": "Niemand folgt diesem Nutzer.",
  ...
  "feeds": "Feeds",
  "feedsAll": "Alle",
  "feedsPinned": "Angeheftet",
  "customFeeds": "Custom Feeds",
  "myFeeds": "Meine Feeds",
  "myFeedsEdit": "Feeds editieren",
  "noMyFeeds": "Keine Feeds. Bitte speichern Sie Feeds.",
  "noPostsInFeed": "Feed ist leer.",
  "noAuthorFeeds": "Nutzer hat keine Feeds.",
  ...
  // ============================================================================
  "search": "Suchen",
  "suggestionSearch": "Tipps",
  "userSearch": "Nutzer finden",
  "postSearch": "Posts finden",
  ...
  "advancedSearch": "Erweitert",
  "searchKeyword": "Suchstichwort",
  "searchSort": "Sortieren",
  "searchLang": "In dieser Sprache suchen",
  "searchNoLang": "Keine Sprache angeben",
  "searchAuthor": "Posts dieses Nutzers suchen",
  "searchMyPosts": "Meine Posts suchen",
  "searchTo": "Antworten an Nutzer suchen",
  "searchMentions": "Erwähnungen des Nutzers suchen",
  "searchMentionsToMe": "Meine Erwähnungen suchen",
  "searchDomain": "Posts mit Domain suchen",
  "searchSince": "Von",
  "searchUntil": "Bis",
  ...
  "videoRemainingDailyNumber": "Videos heute übrig",
  "videoRemainingDailyBytes": "Video-MB heute übrig",
  ...
  "linkcardEmbeddedControl": "Embed-Kontrolle",
  "LinkCardPlaceHolder": "URL/AT URI",
  "urlHasImage": "OGP-Bild anhängen",
  ...
  "contentLanguagesEdit": "Sprachen wählen",
  "contentLanguagesDetail1": "Mehrfachwahl möglich.",
  "contentLanguagesDetail2": "Andere Sprachen werden eingeklappt.",
  "contentLanguagesDetail3": "Bei fehlender Sprachinfo gilt dies nicht.",
  "contentLanguagesDetail4": "Ohne Auswahl: alle Posts sichtbar.",
  "postLanguages": "Beitragssprachen",
  "postLanguagesEdit": "Post-Sprachen wählen",
  ...
  "starterPackEdit": "Starter-Paket editieren",
  ...
  "notificationFilterList": "Benachrichtigung erhalten",
  "notificationFilterIncludeAll": "Alle",
  "notificationFilterIncludeFollows": "Gefolgte",
  "notificationFilterReply": "Antwort-Benachrichtigungen",
  "notificationFilterMention": "Erwähnungs-Benachrichtigungen",
  "notificationFilterQuote": "Zitat-Repost-Benachrichtigungen",
  "notificationFilterRepost": "Repost-Benachrichtigungen",
  "notificationFilterRepostViaRepost": "Repost-von-Repost-Benachrichtigungen",
